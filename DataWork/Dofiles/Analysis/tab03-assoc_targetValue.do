...
********************************************************************************
		...
		CREATES:	   	Table 3: Impact on Total Scheme Target Value of Savings
						"${out_tab}/tab03-assoc_targetValue.tex"
...
* ---------------------------------------------------------------------------- */
	...
	* Add link to the file ([filefilter] does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out}/tab03-assoc_targetValue.tex":${out}/tab03-assoc_targetValue.tex}"'
