...
********************************************************************************
		...
		CREATES:	   	Table 4: Balance Table
						"${out_tab}/tab04-baltab.tex"
...
* ---------------------------------------------------------------------------- *
	...
	* Make final table
	file  open finalFile using "${out_tab}/tab04-baltab.tex"	///
		, text write replace
	...
	* Add link to the file ([filefilter] does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out_tab}/tab04-baltab.tex":${out_tab}/tab04-baltab.tex}"'
