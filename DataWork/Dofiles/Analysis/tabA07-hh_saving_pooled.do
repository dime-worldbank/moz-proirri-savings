...
********************************************************************************
		...
		CREATES:	   	Table A7: Impact on Household Savings per Household – Pooled Outcomes
						"${out_tab}/tabA07-hh_saving_pooled.tex"
...
* ---------------------------------------------------------------------------- */
	...
	* Add link to the file ([filefilter] does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out_tab}/tabA07-hh_saving_pooled.tex":${out_tab}/tabA07-hh_saving_pooled.tex}"'
