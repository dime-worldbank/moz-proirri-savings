...
********************************************************************************
		...
		CREATES:	   	Table A21: Impact on Collective Action Failure Outcomes
						"${out_tab}/tabA21-hh_collective_action.tex"
...
* ---------------------------------------------------------------------------- */
	...
	* Add link to the file ([filefilter] does not provide it automatically)
	di as text `"Open final file in LaTeX here: {browse "${out_tab}/tabA21-hh_collective_action.tex":${out_tab}/tabA21-hh_collective_action.tex}"'
